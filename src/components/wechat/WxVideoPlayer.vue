...
<template>
  <div>
    <div v-if="!outTime">
      <i class="icon-shipinbofang" style="font-size: 80px !important" @click="playVideo()"></i>
      <p>点击播放视频</p>
    </div>
    <div v-if="outTime">
    ...
    <el-dialog title="视频播放" :visible.sync="dialogVideo" width="40%" v-loading="mainLoading" append-to-body>
      <video-player
