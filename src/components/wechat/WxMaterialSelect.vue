    ...
    <div class="waterfall" v-loading="tableLoading">
      <div class="waterfall-item" v-for="item in tableData" :key="item.mediaId">
        ...
        <el-row class="ope-row">
          <el-button size="mini" type="success" @click="selectMaterial(item, objData.appId)">
            选择
    ...
    >
      <template slot-scope="scope" slot="menu">
        <el-button
          ...
          size="small"
          plain
          @click="selectMaterial(scope.row, objData.appId)"
        >
          选择
        </el-button>
      </template>
...
<script>
import { getPage } from '@/api/mp/wxmaterial'
