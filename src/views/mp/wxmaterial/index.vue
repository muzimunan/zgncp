      ...
      <el-col :md="20">
        <el-tabs v-model="materialType" @tab-click="handleClick">
          <el-tab-pane name="image">
            ...
            <div class="add_but">
              <el-upload
                ...
                :data="uploadData"
              >
                <el-button v-if="permissions.mp_wxmaterial_add" size="mini" type="primary">点击上传</el-button>
            ...
            <el-table :data="tableData" stripe border v-loading="tableLoading">
              ...
              <el-table-column fixed="right" label="操作">
                <template slot-scope="scope">
                  <el-button type="text" icon="el-icon-download" size="small" plain @click="handleDown(scope.row)">
                    下载
                  </el-button>
                  <el-button
                    type="text"
          ...
          <el-tab-pane name="video">
            ...
            <div class="add_but">
              <el-button v-if="permissions.mp_wxmaterial_add" size="mini" type="primary" @click="handleAddVideo">
                新建
              </el-button>
            </div>
            <el-dialog title="新建视频" :visible.sync="dialogVideoVisible" v-loading="addMaterialLoading">
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button v-if="permissions.mp_wxmaterial_add" type="primary" @click="subVideo">提 交</el-button>
              </div>
            </el-dialog>
            <el-table :data="tableData" stripe border v-loading="tableLoading">
              <el-table-column prop="mediaId" label="media_id"></el-table-column>
              ...
              <el-table-column fixed="right" label="操作">
                <template slot-scope="scope">
                  <el-button type="text" icon="el-icon-view" size="small" plain @click="handleInfo(scope.row)">
                    查看
                  </el-button>
                  <el-button
                    type="text"
          ...
          <el-tab-pane name="news">
            ...
            <div class="add_but">
              <el-button type="primary" v-if="permissions.mp_wxmaterial_add" @click="handleAddNews" size="mini">
                新 增
              </el-button>
            </div>
            <el-dialog
            ...
            >
              ...
              <div class="right" v-loading="addMaterialLoading">
                ...
                <div>
                  <div class="thumb-div">
                    ...
                    <div class="thumb-but">
                      ...
                      >
                        ...
                        <el-button size="mini" type="primary" @click="openMaterial" style="margin-left: 5px">
                          素材库选择
                        </el-button>
                        <div slot="tip" class="el-upload__tip">支持bmp/png/jpeg/jpg/gif格式，大小不超过2M</div>
                      </el-upload>
                  ...
                  <el-dialog title="选择图片" :visible.sync="dialogImageVisible" width="80%" append-to-body>
                    <WxMaterialSelect
                      :objData="{ repType: 'image', appId: checkAppId }"
              ...
              <div slot="footer" class="dialog-footer">
                ...
                <el-button v-if="permissions.mp_wxmaterial_add" type="primary" @click="subNews">提 交</el-button>
              </div>
            </el-dialog>
            <div class="waterfall" v-loading="tableLoading">
              <div
                class="waterfall-item"
                v-for="item in tableDataActive"
                :key="item.id"
              >
...
<script>
import { addObj, delObj, getMaterialOther, getMaterialVideo, getPage, materialNewsUpdate } from '@/api/mp/wxmaterial'
...
export default {
  ...
  computed: {
    ...
    // 通过计算属性过滤掉列表中不需要显示的项目(20211227为了优化代码eslint而改cyl)
    tableDataActive() {
      return this.tableData.filter((item) => {
        return item.content && item.content.articles
      })
    }
  },
  created() {
