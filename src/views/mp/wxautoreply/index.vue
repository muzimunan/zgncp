        ...
        <el-tabs v-model="type" @tab-click="handleClick">
            ...
            >
              <template slot="menuLeft">
                <div class="add_but" v-if="tableData.length <= 0">
                  <el-button type="primary" @click="handleAdd" size="mini">新 增</el-button>
                </div>
              </template>
              <template slot-scope="scope" slot="menu">
                <el-button type="text" icon="el-icon-edit" size="small" plain @click="handleEdit(scope.row)">
                  编辑
                </el-button>
                <el-button type="text" icon="el-icon-delete" size="small" plain @click="handleDel(scope.row)">
                  删除
                </el-button>
              </template>
            </avue-crud>
          ...
          <el-tab-pane name="3">
            ...
            >
              <template slot="menuLeft">
                <div class="add_but">
                  <el-button type="primary" v-if="permissions.mp_wxautoreply_add" @click="handleAdd" size="mini">
                    新 增
                  </el-button>
                </div>
              </template>
...
export default {
  ...
  computed: {
    ...
    dictDataActive() {
      return this.dictData.get('wx_req_type').filter((item) => {
