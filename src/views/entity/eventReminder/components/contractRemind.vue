<template>
  <div class="contract-remind znp-filter-container">
    <div class="">
    ...
    <div class="">
      <div style="margin-bottom: 16px; margin-top: 16px">
        <el-button
          type="primary"
          size="mini"
          v-if="permissions.entity_contractremind_edit && formParams.handleStatus === 0"
          @click="handleFeePay"
        >
          处理
        </el-button>
...
<script>
import { fetchList, handleRentcontractremind } from '@/api/rentcontractremind'
  ...
  methods: {
    ...
    handleFeePay() {
      ...
      this.$confirm('是否确认处理?', '提示', {
        ...
        handleRentcontractremind(paramData).then(res => {
          if (res && parseInt(res.data.code) === 0) {
            this.$nextTick(() => {
