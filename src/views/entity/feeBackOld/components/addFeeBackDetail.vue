...
import { addObj, putObj } from '@/api/feebackdetails'
import { remote } from '@/api/admin/dict'
import { getSelectFeeitemList } from '@/api/feeItems'
export default {
  name: 'AddFeeBackDetail',
  props: {
    dialogVo: {
      type: Object,
      default: () => null
    ...
    'dialogVo.vo': {
      handler(l) {
        if (this.dialogVo.operateType !== 'add') {
          ...
          this.inputForm.feebackId = l.feeBackId
        }
