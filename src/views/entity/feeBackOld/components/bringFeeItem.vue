...
import { getListByFeeItem, addObjBath } from '@/api/feebackdetails'
...
export default {
  ...
  methods: {
    ...
    saveBtn() {
      ...
      const feebackDetailsList = this.multipleSelection.map((item) => {
        return {
          feebackId: this.bringDialogVo.feebackId,
      ...
      const json = {
        merchantId: this.bringDialogVo.merchantId,
        feebackDetailsList: feebackDetailsList
      }
