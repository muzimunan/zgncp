<template>
  <div class="avue-top">
    ...
    <div class="top-bar__right">
      <div class="current-time top-bar__item">
        {{ userInfo.weekBeginDate }}至{{ userInfo.weekEndDate }} 第{{ userInfo.week }}周
      </div>
      <!-- <el-tooltip
        v-if="showColor"
        effect="dark"
      ...
      <el-tooltip effect="dark" content="用户头像" placement="bottom">
        <img src="/img/user.png" class="top-bar__img" />
      </el-tooltip>
      <el-dropdown>
        <span class="el-dropdown-link">
          {{ userInfo.marketName }} {{ userInfo.username }}
